 ...
 const shareFunc=()=>{
  ...
  return (
    <div className="p-5 text-start w-100" id="registration-Page">
        <label className='d-flex'><img src={verified} alt="" />This Certificate Belong to Sequence No <span> 45892837 </span>is Verified By Nambikkai Inaiyam. </label>
        ...
        <div className='row'>
            ...
            <div className='row w-100 text-end' style={{marginTop:'0px'}}>          
                        <button onClick={handleCertificateData} id="Proceed_button" >Proceed to share your data</button>         
                    </div>
          ...
          <div className='row w-100 text-end' style={{marginTop:'-30px'}}>          
            <button onClick={handleShare} style={{marginLeft:'80%'}}>Share Certificate</button>         
        </div> 
        <Modal
              isOpen={popup}
